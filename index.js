...
/////////////////
const BotName = 'FANI-KUN Bot��'; 
const instagram = 'https://instagram.com/fanhcore__2542'; 
const facebook = 'https://www.facebook.com/jimmy.f.sullivan.3152'; 
const whatsapp = 'http://api.whatsapp.com/send?phone=6282132209625'; 
const kapanbotaktif = 'Ntah gw ga tau, Awokwkwk';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@fanhcore__2542')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@fanhcore__2542`)
})
